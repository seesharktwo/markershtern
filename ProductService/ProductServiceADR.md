...
Таким образом у нас не будет засоряться kafka query запросами
...
для этого типа нужно создать расширение для простого конвертирования в decimal, подробнее [тут](https://visualrecode.com/blog/csharp-decimals-in-grpc/)
