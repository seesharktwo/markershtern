...
namespace UserBagMicroservice.Services
{
    ...
    public class KafkaConsumerService : BackgroundService
    {
        ...
        {
            var consumerBuilder = new ConsumerBuilder<Null, Order_ProductSoldEvent>(_config);
            consumerBuilder.SetValueDeserializer(new Deserializer<Order_ProductSoldEvent>());
