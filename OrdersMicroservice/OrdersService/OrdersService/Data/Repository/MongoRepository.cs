...
namespace OrdersService.Data.Repository
{
        ...
        where TDocument : IDocument
    {
        ...
        public virtual Task CreateIndexAsync()
        {
            return Task.Run(() =>
            {
                var documentBuilder = Builders<TDocument>.IndexKeys;
                ...
                var indexModel = new CreateIndexModel<TDocument>(documentBuilder.Ascending(x => x.Id), option);
